...
public class BeanContato {
    ...
    public String consultarCompromisso(Contato ct){
        return "consultacompromisso.jsf?faces-redirect=true&idcontato="+ct.getIdcontato();
    }

    public String cadastrarCompromisso(Contato ct){
        return "cadastrocompromisso.jsf?faces-redirect=true&idcontato="+ct.getIdcontato();
    }
